const points = [
  "Serious applicants need systems, not scattered advice. ClutchAI is organized around essays, lists, activities, projects, and evidence—not a single prompt box.",
      ...
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1fr_1.1fr] lg:items-center lg:gap-14">
        <div>
          ...
          <p className="mt-4 text-sm leading-relaxed sm:text-base" style={{ color: "var(--text-secondary)" }}>
            Most student AI tools optimize for quick answers. ClutchAI is closer to an <strong style={{ color: "var(--text-primary)", fontWeight: 600 }}>operations layer</strong> for
